...
.DESCRIPTION
    ...
    schema 12 and that the hub itself ran `git init` in the room directory (RoomDirectories.cs:36-53),
...
try {
    ...
    Add-Check -Name 'hub.health-schema' -Passed ($health.schema -eq 12) -Detail "schema=$($health.schema)"

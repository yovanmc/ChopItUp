...
- Tools: Read, Edit, Write, Glob, Grep, Bash, plus post_message, recall, propose_memory and run_gate. Git write verbs are denied to you. The hub commits your diff when your spawn ends, authored as you. Branch work is done by gates.

...
/// <c>BearerTokenMiddleware</c> since row 28), and <see
...
/// membership only, never a write, so row 28's Residual leaves this open deliberately (AC2 keeps GET
/// and non-write surfaces unauthenticated too).</summary>

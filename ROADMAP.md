...
| 11 | Skill substrate: hub-owned skills in `data/skills/`, slash invocation, roster classes, owner-remote credential | 📝 | READY | [plan](docs/superpowers/plans/row11-skill-substrate.md) | Ledger D3, D5, D7, D11; D13 overlay deferred to row 20. 8 tasks, schema v7 = `participants.classes` + `owner-remote` + `skills` fingerprints. Critique 6.4 fable → 7.0 opus, both folded. HIGH. |

...
| 29 | An owner-class credential presented from inside a spawn is refused | 📝 | READY | [plan](docs/superpowers/plans/m29-owner-credential-peer-check.md) | Lever chosen 09-10: the hub maps each loopback connection to its owning PID and refuses an owner-class bearer from inside any live spawn Job Object; cross-room fan-out untouched. Both mechanisms measured 09-10. Expiry declined (shrinks nothing inside the spawn's window). Residuals in plan. Row 13's residual. |

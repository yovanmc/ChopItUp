...
| 70 | Capped parallel Hub tests | 🔨 | READY | [doc](docs/testing/hub-test-resources.md) | Parallel collections under a compiled-in cap of at most 4; env/console/machine-table classes in one non-parallel collection; SpawnerServiceTests (205 of 453 s) split per area. Measure serial/2/4 locally and on CI against 984/984 in 9m59s. |
| 69 | Hub test resource inventory | ✅ | DONE | [doc](docs/testing/hub-test-resources.md) | DONE 2026-09-22: dd213c3 (#143). 64 classes: 27 method, 33 serial, 4 serial+machine; receipt unit is the whole Hub.Tests run. Parallelization unchanged; the capped parallel pilot is a later row. |

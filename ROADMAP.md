...
|---|-------|--------|-------|------|-------|
| 40 | Memory editing page | ✅ | DONE | — | DONE 2026-09-17 (#110, main 5f858d3; deployed, hub schema 12, backup `ChopItUp.backup-20260917-170635`). `Edit memory` dialog; `GET/PUT /api/memory/topics/{slug}` + `preview`; a save is an approved rewrite (`.bak`, commit, note) via `ApproveCore`. .NET 1,219, vitest 188, `Invoke-Row40MemoryEditCheck.ps1` 17/17, capture 25/25, look PASS. Unverified: soft wrap. |

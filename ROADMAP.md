...
| 40 | Memory editing page | 📝 | READY | [row40-memory-editor](docs/superpowers/plans/row40-memory-editor.md) | Owner pick 2026-09-17. Edit `MEMORY.md` and topics from the hub; a save is an approved rewrite (`.bak`, commit, note) under the caps and the spawn 409. HIGH: writes the memory store. Critique 6.8 / 7.3, folded. |

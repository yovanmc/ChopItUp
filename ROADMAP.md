...
| 12 | Desktop shell: WebView2 window that starts the hub, hosts the room UI, sits in the tray | 📝 | READY | [row12-desktop-shell.md](docs/superpowers/plans/row12-desktop-shell.md) | Grill D18. Rulings 09-13 + design round 09-15: WPF host on system WebView2, chromeless window with in-page chrome (the Curio.Shell look, owner pick), hub as a kill-on-close child stopped on Quit, close hides to tray, no autostart. HIGH. Critique pass 1 opus 6.8, pass 2 fable 6.7, 39 findings folded. |

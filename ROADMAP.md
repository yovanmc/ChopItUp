...
| 4b | Flip the repository public | [ ] | OWNER: needs Yovan's explicit yes | — | Split out of M4 so the release can ship without it. Once said, the grill-notes ledger goes with it. No `confidentiality-review` (CLAUDE.md ruling: no employer content); full history scanned clean at `cdb0732` — no db/token/data file ever committed. |

...
| 24 | Memory v1.1c: Claude Code-shape vendor export (`--export-memory`) | [ ] | READY | — | Ledger item 8, split from 23 on 2026-09-08; HIGH (delete/replace path aimed at the owner's real memory dir). Its paired delete of the findings ledger belongs here. Three pass-2 data-loss findings to fold are recorded under item 8 in that ledger. |
